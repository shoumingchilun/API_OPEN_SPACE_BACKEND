...
import generator.domain.InterfaceAccess;
import generator.service.InterfaceAccessService;
import generator.mapper.InterfaceAccessMapper;
import org.springframework.stereotype.Service;

/**
* @author 齿轮
* @description 针对表【interface_access(接口申请表)】的数据库操作Service实现
* @createDate 2024-02-27 13:47:15
*/
@Service
